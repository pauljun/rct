...
@inject('user', 'tab')
@observer
class privateNetTaskManage extends React.Component {
  constructor(props){
    super(props)
    this.libType = 4
    this.state = {
      taskData: {
        taskType: "101504", //101501-黑名单 101502-未知人员布控 101503-魅影
        name:'', // 布控任务名称
        description:'', // 布控任务描述
        ...
        alarmThreshold: 85 // 告警阈值 重点-85  外来-80  魅影-无 一体机-85
      },
      errorShow: false,
      isShowModel: false
    }
  ...
  render() {
    ...
    <div className='monitor-content-wrapper monitee-tasks-add'>
      <div className="task-top">
        <h1 className='tasks-add-title'>新建专网套件布控任务</h1>
      </div>
      <Form
        autocomplete="off"
      >
        <h2 className='header-step-title'>基本信息</h2>
          ...
          />   
        <div>
          <h2 className='header-step-title'>布控对象</h2>
            <LibsList 
          itemDate={taskData}
          errorShow={errorShow}
          changeTasksData={this.changeTasksData}
...
export default privateNetTaskManage
