...
@inject('user', 'tab')
@observer
class eventTaskManage extends React.Component {
  constructor(props){
    super(props)
    this.libType = 3
    this.state = {
      taskData: {
        taskType: "101503", //101501-黑名单 101502-未知人员布控 101503-魅影
        name:'', // 布控任务名称
        description:'', // 布控任务描述
        ...
        libIds: undefined, // 布控库id
        deviceIds: [], // 布控范围
        alarmMode:['1', '2'], // 报警方式
        repeatMode: '8', // 重复方式
        acceptAlarmUserIds: [this.props.user.userInfo.id], // 告警接收人员
        alarmThreshold: undefined // 告警阈值 重点-85  外来-80  魅影-无 一体机-85
      },
      errorShow: false,
      isShowModel: false
    }
  ...
  render() {
    ...
    <div className='monitor-content-wrapper monitee-tasks-add'>
      <div className="task-top">
        <h1 className='tasks-add-title'>新建魅影告警任务</h1>
      </div>
      <Form
        autocomplete="off"
      >
...
export default eventTaskManage
