...
const LibsListView = Loader.loadModuleComponent('MonitorTasks', 'LibsListView')
			...
			<div className="monitor-task-view-edit-container">
				<div className="taks-full-top">
					<div className="task-top">
						...
						{!componentIsEdit && 
							<AuthComponent actionName='outsiderTaskManage'>
