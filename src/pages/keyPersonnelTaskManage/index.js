...
@inject('user', 'tab')
@observer
class keyPersonnelTaskManage extends React.Component {
  constructor(props){
    super(props)
    this.libType = 1
    this.state = {
  ...
  render() {
    ...
    <div className='monitor-content-wrapper monitee-tasks-add'>
      <div className="task-top">
        <h1 className='tasks-add-title'>新建重点人员布控任务</h1>
      </div>
      <Form
        autocomplete="off"
      >
        <h2 className='header-step-title'>基本信息</h2>
          ...
          />   
        <div>
          <h2 className='header-step-title'>重点人员</h2>
            <LibsList 
          itemDate={taskData}
          errorShow={errorShow}
          changeTasksData={this.changeTasksData}
...
export default keyPersonnelTaskManage
