...
@observer
class outsiderLibraryManage extends Component {
  constructor(props) {
    super(props)
    this.libTypeInfo = {
      libType: 2,
      libLabel: '合规人员',
      authAction: 'OutsidersLibsMessage',
      moduleName: 'outsiderLibraryView',
    }
    this.libInfo = {
      userIds: [BaseStore.user.userInfo.id], // 默认选中用户
      libType: 2, // 布控库类型 1- 重点人员  2-外来人员
    }
  }

  componentWillMount() {
    this.props.monitorLib.editSearchData({ libType: 2 });
  }
...
export default outsiderLibraryManage;
