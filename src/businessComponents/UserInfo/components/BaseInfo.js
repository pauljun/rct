...
class BaseInfo extends React.Component {
  ...
  componentDidMount() {
    const { location, isAdd ,form} = this.props;
          ...
          <Col span={24}>
            ...
            <FormItem label="有效期限:">
              {getFieldDecorator('validEndTime',{
                initialValue: isAdd ? moment().add(3, 'year') : initData.validEndTime ? moment(Number(initData.validEndTime)):moment().add(3, 'year')})(
                <DatePicker
                  name="validEndTime"
                  className="datePick"
                  format="YYYY.MM.DD"
